...
<div id="social-media">
    ...
    <a href="aim:addbuddy?screenname=isuPatches"><img src="/images/social-media/aim.png" alt="Add Patches on AIM"
    ...
    <a href="https://github.com/isuPatches"><img src="/images/social-media/github.png" alt="Follow Patches on GitHub"
                                                 title="Follow Patches on GitHub" style="width:35px;height:auto;"/></a>
    <a href="https://plus.google.com/u/0/+SarahKlinefelter89/posts"><img src="/images/social-media/google.png"
                                                                         alt="Add Patches on Google+"
                                                                         title="Add Patches on Google+"/></a>
    <a href="https://plus.google.com/u/0/+Rockthepatch/posts"><img src="/images/social-media/google-fan.png"
                                                                   alt="Follow Patches' Google+ Fan Page"
                                                                   title="Follow Patches' Google+ Fan Page"/></a>
    <a href="http://pinterest.com/isuPatches/"><img src="/images/social-media/pinterest.png"
                                                    alt="Follow Patches on Pintrest" title="Follow Patches on Pintrest"
                                                    style="width:28px;height:auto;"/></a>
    <a href="http://www.last.fm/user/isuPatches"><img src="/images/social-media/lastfm.png" alt="Add Patches on Last FM"
    ...
    <a href="https://www.rockthepatch.com/rss/current-events.xml" type="application/rss+xml"><img
            src="/images/social-media/rss.png" alt="View or Subscribe to Patches' RSS Feed" title="Patches' RSS Feed"/></a>
    ...
    <a href="http://pulse.yahoo.com/_FWIZRSMLF3GEXRTMKJKO3TDUVY"><img src="/images/social-media/yahoo.png"
                                                                      alt="Add Patches on Yahoo"
                                                                      title="Add Patches on Yahoo"/></a>
    <!--suppress HtmlUnknownTarget -->
    <a href="ymsgr:addfriend?isuPatches"><img src="/images/social-media/yahoomessenger.png"
    ...
    <a href="http://www.youtube.com/isuPatches"><img src="/images/social-media/youtube.png"
                                                     alt="Subscribe to Patches on YouTube (current)"
                                                     title="Subscribe to Patches on YouTube (current)"/></a>
    <a href="http://www.youtube.com/ccPatches"><img src="/images/social-media/youtubealt.png"
                                                    alt="Subscribe to Patches on YouTube (old)"
                                                    title="Subscribe to Patches on YouTube (old)"/></a>
</div>
<div id="note">
