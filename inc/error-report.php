...
<form method="post" name="error-report-form" action="/user-system/error-report-validate.php" enctype="multipart/form-data">
	...
	?>
	<p><strong>Screen Shot:</strong></p><div class="file-input"><p><input type="file" name="file"/></p></div>
...
<p style="word-break:break-all;">
	Need anything else? Email Patches at:<br/> <a href="mailto:<?php global $masterAdminEmail; echo($masterAdminEmail); ?>?subject='Rock%20the%20Patch!'%20Email%20from%20user" title="Email <?php global $masterAdminName; echo($masterAdminName); ?>"><?php global $masterAdminEmail; echo($masterAdminEmail); ?></a>
</p>