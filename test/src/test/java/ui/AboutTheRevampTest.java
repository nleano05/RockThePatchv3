...
@Browser
public class AboutTheRevampTest extends BasePageTest implements BasePageTest.Callbacks {

    private static final String TAG = IndexTest.class.getSimpleName();

    private static WebDriver sDriver;

    private static final String PAGE_URL = UrlUtil.URL_ABOUT_THE_REVAMP;
    ...
    public void testTitle() {
        BasePageTest.testTitle(sDriver, PAGE_URL, Constants.TITLE_ABOUT_THE_REVAMP);
    }
