...
<head>
    ...
    <title>Rock the Patch! v3 - Hot Link Prevented</title>
...
<!-- ### START container ### -->
<div class="container">
    <h2 style="color:red;"><em>This ip address has been blocked from www.rockthepatch.com and will not be able to see it.</em></h2>
    <p><em>If you feel this is in error, please contact Patches at <a href="mail:patches@rockthepatch.com" title="Patches">patches@rockthepatch.com</a></em></p>
</div>
<!-- ### END Container ### -->
</body>
<!-- ### END Body ### -->
