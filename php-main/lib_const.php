...
define("SELECT_A_FEATURE_REQUEST_CATEGORY_TO_DELETE", "-- SELECT FEATURE REQUEST CATEGORY TO DELETE --");
define("SELECT_A_FEATURE_REQUEST_CATEGORY_TO_EDIT", "-- SELECT FEATURE REQUEST CATEGORY TO EDIT --");
