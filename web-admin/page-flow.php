...
<head>
    ...
    <title>Rock the Patch! v3 - Page Flow</title>
...
<div class="container">
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / <a href="/web-admin/main.php" title="Web Admin">Web Admin</a> / Page Flow</div>
        <h1>Page Flow</h1>
        ...
        <?php
                    $pageFlowFilters = array("sessionId", "user");
                    $pageFlowLabels = array("Session ID", "User");

                    lib_database::displayFilterForm("Page Flow", PAGE_PAGE_FLOW, $pageFlowFilters, $pageFlowLabels, TABLE_PAGE_LOG);
                    lib_database::displayFilteredEntries($pageFlowFilters, TABLE_PAGE_LOG, PAGE_PAGE_FLOW);
                } else {
