...
<head>
    ...
    <title>Rock the Patch! v3 - Page Statistics</title>
...
<div class="container">
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / <a href="/web-admin/main.php" title="Web Admin">Web Admin</a> / Page Statistics</div>
        ...
        <?php
                    lib_database::displayPageStatistics();
                } else {
