...
<div class="container">
    ...
    <div id="content-area">
        ...
        ?>
                    <h2>Admin Users</h2>
                    <!-- ### START Revoke Admin Access form ### -->
                    <form method='post' action='revoke-admin-access.php' name='Revoke Admin Access'>
                        <?php lib_database::displayAdminUsers(); ?>
                        <p><input type='submit' name='revoke-admin-access.php' value='Revoke Admin Access' class="button" /></p>
                    </form>
                    <!-- ### END Revoke Admin Access form ### -->

                    <hr/>

                    <h2>Non-Admin Users</h2>
                    <!-- ### START Grant Admin Access form ### -->
                    <form method='post' action='grant-admin-access.php' name='Grant Admin Access'>
                        <?php lib_database::displayNonAdminUsers(); ?>
                        <p><input type='submit' name='grant-admin-access.php' value='Grant Admin Access' class="button" /></p>
                    </form>
