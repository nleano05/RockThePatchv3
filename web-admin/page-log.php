...
<head>
    ...
    <title>Rock the Patch! v3 - Page Log</title>
...
<div class="container">
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / <a href="/web-admin/main.php" title="Web Admin">Web Admin</a> / Page Log</div>
        <h1>Page Log</h1>
        ...
        <?php
            ...
            if($gLoginStatus == STATUS_LOGGED_IN) {
                if ($isAdmin) {
        ?>
                    <form action="clear-page-log-and-statistics.php" name="clear-page-log-and-statistics" method="post">
                        <p><input type="submit" value="Clear Page Log and Statistics" class="button" /></p>
                    </form>
        <?php
                    $pageLogFilters = array("page", "user", "referer", "fullAgent", "agent", "agentVersion", "os", "osVersion", "remoteAddress", "isp", "country", "city", "state", "time");
                    $pageLogLabels = array("Page", "User", "Referer", "Full Agent", "Agent", "Agent Version", "OS", "OS Version", "Remote IP", "ISP", "Country", "City", "State", "Time");

                    lib_database::displayFilterForm("Page Log", PAGE_PAGE_LOG, $pageLogFilters, $pageLogLabels, TABLE_PAGE_LOG);
                    lib_database::displayFilteredEntries($pageLogFilters, TABLE_PAGE_LOG, PAGE_PAGE_LOG);
                } else {
