...
<head>
    ...
    <title>Rock the Patch! v3 - Account Lock Administration</title>
...
<div class="container">
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / <a href="/web-admin/main.php" title="Web Admin">Web Admin</a> / Account Lock Administration</div>
        <h1>Account Lock Administration</h1>

        <?php
            if(lib_get::loginStatus() == STATUS_LOGGED_IN) {
                if(lib_check::userIsAdmin()) {
                    lib_database::displayUsersAccountLockAdministration(TRUE);
                    echo("<hr/>");
                    lib_database::displayUsersAccountLockAdministration(FALSE);
                } else {
