...
<head>
    ...
    <title>Rock the Patch! v3 - Error Log</title>
...
<div class="container">
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / <a href="/web-admin/main.php" title="Web Admin">Web Admin</a> / Error Log</div>
        <h1>Error Log</h1>
        ...
        <?php
            ...
            if($gLoginStatus == STATUS_LOGGED_IN) {
                if ($isAdmin) {
        ?>
                <form action="clear-error-log-and-statistics.php" name="clear-error-log-and-statistics" method="post">
                    <p><input type="submit" value="Clear Error Log and Statistics" class="button" /></p>
                </form>
        <?php
                    $errorLogFilters = array("errorCode", "user", "requestURI", "referer", "time", "type");
                    $errorLogLabels = array("Error Code", "User", "Request URI", "Referer", "Time", "Type");

                    lib_database::displayFilterForm("Error Log", PAGE_ERROR_LOG, $errorLogFilters, $errorLogLabels, TABLE_ERROR_LOG);
                    lib_database::displayFilteredEntries($errorLogFilters, TABLE_ERROR_LOG, PAGE_ERROR_LOG);
                } else {
