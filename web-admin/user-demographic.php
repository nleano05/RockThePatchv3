...
<head>
    ...
    <title>Rock the Patch! v3 - User Demographic</title>
...
<div class="container">
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / <a href="/web-admin/main.php" title="Web Admin">Web Admin</a> / User Demographic</div>
        <h1>User Demographic</h1>
        ...
        <?php
            ...
            if($gLoginStatus == STATUS_LOGGED_IN) {
                if ($isAdmin) {
                    lib_database::displayUserDemographic();
                } else {
