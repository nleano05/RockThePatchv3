...
<head>
    ...
    <title>Rock the Patch! v3 - Login Statistics</title>
...
<div class="container">
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / <a href="/web-admin/main.php" title="Web Admin">Web Admin</a> / Login Statistics</div>
        ...
        <?php
                    ...
                    lib_database::displayFilteredEntries($loginStatisticsFilters, TABLE_LOGIN_STATISTICS, PAGE_LOGIN_STATISTICS);
                } else {
