...
<head>
    ...
    <title>Rock the Patch! v3 - Palindrome Checker</title>
...
<div class="container">
        ...
        <div id="site-nav">
            ...
            <div id="nav-bar">
                ...
                <script type="text/javascript">
                    ...
                    document.getElementById("palindrome-checker").className  = "current";
                </script>
            </div>
            <!-- ### END nav-bar ### -->
            <!-- ### START user-nav ### -->
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / Bonus / Palindrome Checker</div>

        <h1>Palindrome Checker</h1>

        <p>Curious if your string is a palindrome (meaning it reads the same backwards and forwards)? Find out here!</p>

        <form action="palindrome-checker.php" method="post" name="palindrome-checker">
            <p><strong>Input to check:</strong></p>
            <p><input type='text' name='palindrome-input' value='<?php if(isset($_POST['palindrome-input'])) { echo($_POST['palindrome-input']); }?>' /></p>
