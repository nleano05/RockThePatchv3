...
<head>
    ...
    <title>Rock the Patch! v3 - Downloads</title>
...
<div class="container">
    ...
    <div id="header">
        ...
        <div id="site-nav">
            ...
            <div id="user-nav">
                ...
                ?>
                    <script type="text/javascript">
                        document.getElementById("downloads").className  = "current";
                    </script>
                <?php
                    }
                ?>
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / Downloads</div>
        ...
        <?php
            if($gLoginStatus == STATUS_LOGGED_IN) {
        ?>
            <p>You have been granted access to download certain materials such as important 'Rock the Patch!' documents, music,
                and computer applications.  Click on what you want from the sections below and enjoy!</p>

            <h2>Programs</h2>
            <ul>
                <li><a href="/downloads/ResourceManager.jar" title="Resource Manager">Resource Manager</a></li>
                <li><a href="/downloads/ticTacToe.exe" title="T3 - Tic Tac Toe to the Extreme">T3- Tic Tac Toe to the Extreme</a></li>
            </ul>
        <?php
            }else {
