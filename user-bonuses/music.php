...
<head>
    ...
    <title>Rock the Patch! v3 - Music</title>
...
<div class="container">
        ...
        <div id="site-nav">
            ...
            <div id="user-nav">
                ...
                if($gLoginStatus == STATUS_LOGGED_IN) {
                    ?>
                    <script type="text/javascript">
                        document.getElementById("music").className  = "current";
                    </script>
                    <?php
                }
                ?>
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / Music</div>
        ...
        <?php
            if($gLoginStatus == STATUS_LOGGED_IN) {
        ?>
                <p>Stream or download any of the songs below! (<em>All of these files are <strong>.mp3</strong> format.</em>)</p>

                <ul>
                    <li>Complicated Matters - <a href="/audio/complicated-matters.mp3" title="Complicated Matters">Stream</a> <a href="/audio/complicated-matters.zip">Download</a></li>
                    <li>Try And Catch Me - <a href="/audio/try-and-catch-me.mp3" title="Try and Catch Me">Stream</a> <a href="/audio/try-and-catch-me.zip">Download</a></li>
                    <li>Demonic - <a href="/audio/demonic.mp3" title="Demonic">Stream</a> <a href="/audio/demonic.zip">Download</a></li>
                    <li>Strummin', Hummin' Along - <a href="/audio/strummin-hummin-along.mp3" title="Strummin', Hummin' Along">Stream</a> <a href="/audio/strummin-hummin-along.zip">Download</a></li>
                </ul>
        <?php
            }else {
