...
<head>
    ...
    <title>Rock the Patch! v3 - Special News</title>
...
<div class="container">
        ...
        <div id="site-nav">
            ...
            <div id="user-nav">
                ...
                if($gLoginStatus == STATUS_LOGGED_IN) {
                    ?>
                    <script type="text/javascript">
                        document.getElementById("special-news").className  = "current";
                    </script>
                    <?php
                }
                ?>
    ...
    <!-- ### START content-area ### -->
    <div id="content-area">
        <div id="bread-crumbs"><a href="/" title="Home">Home</a> / Special News</div>
        ...
        <?php
            if($gLoginStatus == STATUS_LOGGED_IN) {
        ?>
                <h2>Release of Rock the Patch! v3</h2>

                <!-- TODO - write this up before the release -->
                <p>
                    <em></em>
                </p>
        <?php
